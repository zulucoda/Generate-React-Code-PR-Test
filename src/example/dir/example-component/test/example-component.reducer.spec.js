...
import exampleComponentReducer, {
    exampleAction,
    exampleAsyncAction
    /*
...
describe('exampleComponentReducer - Unit Test', () => {
    ...
    it('should return initial state when action is undefined', () => {
        ...
        const actual = exampleComponentReducer(undefined, action);
    ...
    it('should return current state when unknown action is dispatched', () => {
        ...
        const actual = exampleComponentReducer(currentState, action);
    ...
    */
    describe('exampleAction', () => {
        it('should send humans to Mars to recolonise', () => {
            ...
            const actual = exampleComponentReducer(stateBefore(), action);
