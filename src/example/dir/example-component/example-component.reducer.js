...
const reducerName = 'example-component';
...
export function exampleAsyncAction() {
    return (dispatch, getState) => {
        const { exampleComponentReducer } = getState();
        dispatch(exampleAction(!exampleComponentReducer.exampleVariable));
    };
}
...
export default function exampleComponentReducer(state = initialSate, action) {
    switch (action.type) {
