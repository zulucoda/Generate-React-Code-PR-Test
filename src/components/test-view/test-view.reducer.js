...
export function exampleAsyncAction() {
    return (dispatch, getState) => {
        const { testViewReducer } = getState();
        dispatch(exampleAction(!testViewReducer.exampleVariable));
    };
}
...
export default function testViewReducer(state = initialSate, action) {
    switch (action.type) {
